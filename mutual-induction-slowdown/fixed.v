...
Fixpoint basic_eval_unique TC GC G t ve1 ve2
         (be1 : basic_eval TC GC G t ve1)
         (be2 : basic_eval TC GC G t ve2) {struct be1} : ve1 = ve2
with basic_eval_cs_unique TC GC G cs vm v1 v2
         (be1 : basic_eval_cs TC GC G cs vm v1)
         (be2 : basic_eval_cs TC GC G cs vm v2) {struct be1} : v1 = v2
with basic_eval_equation_unique TC GC G eq v1 v2
         (be1 : basic_eval_equation TC GC G eq v1)
         (be2 : basic_eval_equation TC GC G eq v2) {struct be1} :
       v1 = v2.
Proof.
{
  generalize dependent ve2. induction be1; intros ve2 be2; inversion be2.
  (*attr*)
...
{
  generalize dependent v2. induction be1; intros v2 be2; inversion be2.
